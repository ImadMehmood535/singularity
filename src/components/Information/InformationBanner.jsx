import { amazonlogo1, amazonlogo2 } from "@/assets";
            ...
            {btntext && (
              <>
                <div className="flex justify-between flex-col md:flex-row gap-4 items-center mb-8">
                  <Image src={amazonlogo1} width={200} height={100} className="w-full"/>
                  <Image src={amazonlogo2} width={200} height={100} className="w-full"/>
                </div>
                <div className="flex">
