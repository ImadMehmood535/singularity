    ...
    <div className="ImpressumBody bg-[#0F121D] text-white">
      <div className="containerCust">
        <div className="flex flex-col items-center gap-5 containerCust !py-12">
          <p>Please see the Singularity GmbH Privacy Policy below.</p>
          <p>
            For your convenience this is shown first in English and then in
            German below:
          </p>
          ...
          <p>
            WIX is a tool for creating and hosting websites. When you visit our
            website, WIX analyses user behavior, visitor sources, region of
            website visitors and visitor numbers. The WIX stores cookies on your
            browser, which are necessary for the presentation of the website and
            to ensure security (necessary cookies).
          </p>

          <p>
            The data is stored on the servers of WIX in Israel. Israel is
            considered to be a third country that is safe from data protection
            laws. This means that Israel has a level of data protection
            equivalent to that of the European Union.
          </p>

          <p>
            Details can be found in the privacy policy of WIX:{" "}
            <Link href="https://de.wix.com/about/privacy">
          ...
          <p>
            The WIX is used on the basis of Art. 6(1)(f) GDPR. We have a
            legitimate interest the most reliable presentation of our website.
          ...
          <address>
            <strong>Singularity GmbH</strong>
            <br />
            Steuerberatungsgesellschaft
            <br />
            Geschäftsführer StB Marko Kaiser
            <br />
            <br />
            Steuerberatungsgesellschaft
            <br />
            ...
            <br />
            Email:{" "}
            <Link href="mailto:anfragen@singularity.tax">
              anfragen@singularity.tax
            </Link>
            <br />
            Phone: +49-2163-951-89690
          </address>
          ...
          <p>
            ...
            DSGVO. If you have consented to the storage of cookies or to the
          ...
          <address>
            ...
            <br />
            <br />
            Datenschutzbeauftragte: Melanie Tiefenbach
            <br />
            <br />
            Telefon: +49 (0)2162 – 919790
            <br />
            E-Mail:{" "}
          ...
          <h2>Information about, rectification and eradication of data</h2>
          ...
          <ul>
            ...
            <h4>Recording of data on this website</h4>
            ...
            <p>
              ...
              communication transactions, or for the provision of certain
              ...
              the storage of the cookies and similar recognition technologies
              has been requested, processing occurs exclusively on the basis of
              the consent obtained (Art. 6(1)(a) GDPR and § 25 (1) TTDSG); this
            ...
            <p>
              ...
              the assistance of humans. To do this, chatbots analyze your
              entries and other data to give matching responses (e.g., names,
              email addresses and other contact information, customer numbers
              and other identification, orders, and chat progresses). The
              chatbot can also register your IP address, log files, location
              information, and other meta data. The data is archived on the
              servers of the chatbot provider.
            </p>
            ...
            <p>
              ...
              advertising if the other legal requirements are met (in particular
              if consent has been obtained). Moreover, it is possible to link
              chatbots to analytical and advertising tools.
            </p>
            ...
            <p>
              We or the chatbot operator retain the data you enter until you ask
              us to delete it, revoke your consent to archive it or if the
              purpose for the data storage is no longer in effect (e.g., once
              your inquiry has been fully processed). This does not affect
              mandatory statutory provisions – in particular, retention time
              frames.
            </p>

            <p>
              The legal basis for the use of chatbots is Art. 6(1)(b) GDPR, if
              the chatbot is used to negotiate a contract or in conjunction with
              the fulfillment of a contract. If appropriate consent has been
              ...
              meaning of the TTDSG. This consent can be revoked at any time. In
              all other cases, the use is based on our legitimate interest in
              the most effective client communication possible (Art. 6(1)(f)
              GDPR).
            </p>
            <h4>Social media</h4>

            <h5>LinkedIn plug-in</h5>
            ...
            <p>
              The use of the LinkedIn plug-in is based on Art. 6(1)(f) GDPR. The
              operator of the website has a legitimate interest in being as
              visible as possible on social media. If appropriate consent has
            ...
            <p>
              ...
              applications to us (e.g., via e-mail, via postal services or by
              submitting the online job application form). Below, we will brief
              you on the scope, purpose, and use of the personal data collected
              from you in conjunction with the application process. We assure
              you that the collection, processing, and use of your data will
              occur in compliance with the applicable data privacy rights and
            ...
            <p>
              ...
              establishment or an employment relationship. The legal grounds for
              the aforementioned are § 26 GDPR according to German Law
              (Negotiation of an Employment Relationship), Art. 6(1)(b) GDPR
              (General Contract Negotiations) and – provided you have given us
              your consent – Art. 6(1)(a) GDPR. You may revoke any consent given
              at any time. Within our company, your personal data will only be
              shared with individuals who are involved in the processing of your
              job application.
            </p>

            <p>
              If your job application should result in your recruitment, the
              data you have submitted will be archived on the grounds of § 26
              GDPR and Art. 6(1)(b) GDPR for the purpose of implementing the
            ...
            <p>
              ...
              application procedure (rejection or withdrawal of the
              application). Afterwards, the data will be deleted, and the
              ...
              If it is evident that the data will be required after the expiry
              of the 6-month period (e.g., due to an impending or pending legal
              dispute), deletion will only take place when the purpose for
            ...
            <p>
              WIX ist ein Tool zum Erstellen und Hosten von Webseiten. Wenn Sie
              unsere Website besuchen, werden mithilfe von WIX das
            ...
            <p>
              ...
              <Link href="https://de.wix.com/about/privacy" target="_blank">
                https://de.wix.com/about/privacy
              </Link>
              .
            </p>
          ...
          <h4>Datenschutz­beauftragter</h4>
          ...
          <p>
            ...
            Chatverläufe). Ferner können über den Chatbot Ihre IP-Adresse,
            Logdateien, Standortinformationen und andere Metadaten erfasst
            werden. Diese Daten werden auf den Servern des Chatbot-Anbieters
            gespeichert.
          </p>

          <p>
            Auf Grundlage der erfassten Daten können Nutzerprofile erstellt
            werden. Außerdem können die Daten zur Ausspielung
            interessengerechter Werbung genutzt werden, sofern die übrigen
            rechtlichen Voraussetzungen (insbesondere eine Einwilligung) hierfür
            vorliegen. Dazu können die Chatbots mit Analyse- und Werbetools
            verknüpft werden.
          </p>

          <p>
            Die erfassten Daten können außerdem dazu genutzt werden, um unsere
            Chatbots und ihr Antwortverhalten zu verbessern (maschinelles
            Lernen).
          </p>
          ...
          <p>
            Rechtsgrundlage für den Einsatz von Chatbots ist Art. 6 Abs. 1 lit.
            b DSGVO, sofern der Chatbot zur Vertragsanbahnung oder im Rahmen der
            Vertragserfüllung eingesetzt wird. Sofern eine entsprechende
            ...
            ist jederzeit widerrufbar. In allen anderen Fällen erfolgt der
            Einsatz auf Grundlage unseres berechtigten Interesses an einer
            möglichst effektiven Kundenkommunikation (Art. 6 Abs. 1 lit. f
            DSGVO).
          </p>
          ...
          <p>
            Diese Website nutzt Funktionen des Netzwerks LinkedIn. Anbieter ist
          ...
          <p>
            Die Verwendung des LinkedIn-Plugins erfolgt auf Grundlage von Art. 6
            ...
            im Sinne des TTDSG umfasst. Die Einwilligung ist jederzeit
            widerrufbar.
          </p>
          ...
          <h5>Umgang mit Bewerberdaten</h5>
          ...
          <h5>Aufbewahrungsdauer der Daten</h5>
