                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="flex flex-row justify-between items-start gap-1">
                    ...
                    <div className="button-wrapper  w-1/3">
                      <button
                        disabled={loading}
                        className="bg-[#32BB98] border-[1.5px] border-[#32BB98] w-full rounded-full font-medium text-white  table py-3 transition-all duration-200 cursor-pointer text-center hover:bg-black"
                      >
                        Subscribe
                      </button>
                    </div>
