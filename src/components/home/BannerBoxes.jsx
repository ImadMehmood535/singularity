...
const BannerBoxes = () => {
  return (
    <div className="relative flex items-center ">
      <figure className="relative z-10 md:-mb-[40px] -mr-[100px] md:-mr-6 top-0 hover:-top-[10%] transition-all  ">
        <Image
          src={box1}
      ...
      <figure className="relative md:z-30 -mb-5 -ml-[100px] md:-ml-5 top-0 hover:-top-[10%] transition-all ">
        <Image
          src={box3}
