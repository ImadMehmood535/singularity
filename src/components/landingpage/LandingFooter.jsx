        ...
        <div className="containerCust">
          <div className="flex justify-between items-start flex-col md:flex-row  gap-8">
            <div className="">
              ...
              <h4 className="capitalize font-semibold text-lg mb-4">
                Follow us on
              </h4>
              <div className="social-list mt-5">
                <ul className="flex flex-row gap-2 justify-start">
                  ...
                  >
                    <li
                      className={`p-3 rounded-lg bg-[#464646] hover:bg-[#32BB98] text-white hover:text-white   transition-all duration-200 `}
                    >
                      <RiFacebookFill />
                    </li>
                  </Link>
            ...
            <div className="w-full md:w-[50%] lg:w-[30%]">
              <div className="newsletter">
                ...
                <p className="mb-3  font-[300] text-base text-white">
                  Get Notification regarding rule and regulation updates in your
                  mail box
                </p>
                <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="flex flex-row justify-between items-center gap-1">
                    ...
                    <div className="button-wrapper  w-1/3">
                      <button className="bg-[#32BB98] border-[1.5px] border-[#32BB98] w-full rounded-full font-medium text-white  table py-3 transition-all duration-200 cursor-pointer text-center hover:bg-black">
                        Suscribe
                      </button>
                    </div>
                  </div>
          ...
          <div className="  relative z-20">
            ...
            <div className="bottom-footer flex-wrap mb-6 font-[300] text-sm w-full flex flex-col justify-between md:flex-row  items-center">
              <div className="rights-text">
                <p className="text-center md:text-left mb-3 font-[300] text-sm">
